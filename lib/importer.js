...
// function updateImageImports(entry, deploy) {
// 	log('Updating image-imports');
// 	if (!entry) {
// 		log('Cannot watch/compile images!! No entry specified (compiler.options.entry.image)');
...
// function updateFontImports(entry, deploy) {
// 	log('Updating font-imports');
// 	if (!entry) {
// 		log('Cannot watch/compile fonts!! No entry specified (compiler.options.entry.font)');
